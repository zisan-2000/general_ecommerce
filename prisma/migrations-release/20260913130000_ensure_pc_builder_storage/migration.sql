-- Existing installations may have recorded the squashed baseline without ever
-- receiving the archived PC Builder migrations. Keep this migration idempotent
-- so it repairs those databases and remains harmless on clean installations.
